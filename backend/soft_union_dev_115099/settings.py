"""
Django settings for soft_union_dev_115099 project.
...
ROOT_URLCONF = 'soft_union_dev_115099.urls'
...
WSGI_APPLICATION = 'soft_union_dev_115099.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_union_dev_115099 API",
    "DESCRIPTION": "API documentation for soft_union_dev_115099 App",
    "VERSION": "v1",
}
