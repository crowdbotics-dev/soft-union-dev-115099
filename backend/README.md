...
## Project Structure
    ...
    ├── soft_union_dev_115099  # Django project configurations
...
1. Clone this repo and `cd soft_union_dev_115099`
...
2. Clone this repo and `cd soft_union_dev_115099`
